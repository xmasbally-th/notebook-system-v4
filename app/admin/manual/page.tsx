                ...
                <div className="space-y-12">
                    ...
                    <Section id="dashboard" title="1. ภาพรวมระบบ (Dashboard)" icon={LayoutDashboard} color="blue">
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <FeatureItem title="สถิติหลัก" desc="สรุปจำนวนอุปกรณ์ทั้งหมด, คำขอรออนุมัติ, การยืมที่กำลังดำเนินการ, และผู้ใช้งานในระบบ" />
                            <FeatureItem title="ดำเนินการด่วน" desc="ปุ่มลัดสำหรับเพิ่มอุปกรณ์, ดูคำขอยืม, จัดการผู้ใช้, หรือดูรายงานอย่างรวดเร็ว" />
                            <FeatureItem title="สถานะระบบ" desc="ตรวจสอบการเปิด/ปิดระบบยืม-คืน และเวลาทำการ" />
                        </ul>
                    </Section>
